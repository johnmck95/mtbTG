						...
						<VStack
							...
							<SimpleGrid columns={2} columnGap={2} w='75%' pb={4}>
								...
								<GridItem colSpan={1} w='100%' textAlign='right'>
									<Text>
										{imperialRider
											? parseFloat(inputs.weightLB).toFixed(0) + 'lb'
											: parseFloat(inputs.weightKG).toFixed(0) + 'kg'}
									</Text>
								</GridItem>
								<GridItem colSpan={1} w='100%' textAlign='left'>
									<Text>Handling</Text>
					...
					<VStack w={['100%', '80%']} bg='brand.darkGrey' borderRadius='md'>
						<HStack w='100%' justify='space-between'>
							<HStack w={['60%', '80%']} justify='center' position='relative'>
								...
								/>
								<Heading fontSize={['lg', 'xl']} ml='auto' pl={4} pt={4}>
									YOUR SETTINGS
								</Heading>
							</HStack>
							<Box position='relative' top='20px'>
								<Button
									...
									onClick={() =>
										setMetricOutput((prevMetricOutput) => !prevMetricOutput)
									}
									_hover={
										metricOutput
											? {
						...
						<SimpleGrid
							...
							<GridItem colSpan={3}>
								<Text color='red.300' textAlign='justify'>
									<b>
										IMPORTANT: The Tuning Guide is under active development and
